    ...
    public partial class Form_ThemSuaHangHoa : Form
    {
        ...
        private void btnHoanTat_Click(object sender, EventArgs e)
        {
            ...
            if (ModeHH == 1)
            {
                ...
                {
                    sqlCon.Open();
                    string strquery = "insert into SANPHAM values('" + txtSPID.Text + "',N'" + txtTenSP.Text + "',N'" + txtLoaiSP.Text + "',N'" + txtNuocSX.Text + "'," + txtGiaNhap.Text + "," + txtGiaBan.Text
                        + ",'" + txtDVT.Text + "'," + txtSL.Text + "," + txtSLTT.Text + ",N'" + txtMoTa.Text + "')";
